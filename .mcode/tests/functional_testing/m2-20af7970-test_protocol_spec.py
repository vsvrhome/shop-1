...
Generated at: 2026-03-26T05:56:41.715207+00:00
Project: shop-1
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "POST",
        "description": "Attempt to create a category without required name field",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_category_name_only",
        "category": "HAPPY_PATH",
        "endpoint": "/categories",
        "method": "POST",
        "description": "Create a category with name only, omitting optional description",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "GET",
        "description": "List all categories (returns empty array or populated list)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "list_categories_after_creation",
        "category": "HAPPY_PATH",
        "endpoint": "/categories",
        "method": "GET",
        "description": "Create a category then verify it appears in the list",
        "setup": {
            "endpoint": "/categories",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Create a product without a category (category_id is optional)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Attempt to create a product with a non-existent category_id",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "GET",
        "description": "List all products (returns empty array or populated list)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "list_products_after_creation",
        "category": "HAPPY_PATH",
        "endpoint": "/products",
        "method": "GET",
        "description": "Create a product then verify it appears in the product list",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product (which auto-initializes inventory) then retrieve its inventory",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "GET",
        "description": "Attempt to get inventory for a non-existent product",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Attempt to update inventory for a non-existent product",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
    ...
    {
        "name": "update_inventory_missing_quantity",
        "category": "MISSING_REQUIRED",
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Attempt to update inventory without providing the required quantity field",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a product (inventory starts at 0) and attempt to reserve units, expecting failure due to insufficient stock",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "reserve_inventory_missing_quantity",
        "category": "MISSING_REQUIRED",
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Attempt to reserve inventory without providing the required quantity field",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Attempt to reserve inventory for a non-existent product",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
