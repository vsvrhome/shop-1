...
Generated at: 2026-03-26T05:50:24.724449+00:00
Project: shop-1
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Verify the health check endpoint returns healthy status and service name",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user with an email that already exists, expect 400",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without the required email field, expect 400 or 422",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_user_missing_name",
        "category": "MISSING_REQUIRED",
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without the required name field, expect 400 or 422",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users/{user_id}",
        "method": "GET",
        "description": "Attempt to retrieve a user with a non-existent ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "user_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "List all users, expect a JSON array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "list_users_after_creation",
        "category": "HAPPY_PATH",
        "endpoint": "/users",
        "method": "GET",
        "description": "Create a user then list all users to verify the new user appears",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
